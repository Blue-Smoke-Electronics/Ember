...
class Pcb{
    ...
    public: 
        ...
        static const int encoder_current_A_pin = 10; 
        static const int encoder_current_B_pin = 11; 
        static const int encoder_current_switch_pin = 12; 
        static const int encoder_voltage_A_pin  =13; 
        static const int encoder_voltage_B_pin = 14; 
        static const int encoder_voltage_switch_pin = 15; 
        static const int on_off_switch_pin = 16; 
        static const int on_off_latch_pin = 17; 
        static const int ouput_on_of_switch_pin  =18; 
