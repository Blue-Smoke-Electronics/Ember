...
namespace image_to_flash_transfer
{
    public partial class Form1 : Form
    {
        ...
        private void button14_Click(object sender, EventArgs e)
        {
            ...
            save_to_H_file("timeFont", new Font("Consolas", 10), Brushes.Black, "01923456789hm".ToCharArray());
            save_to_H_file("smallFont", new Font("Consolas", 12),Brushes.Black, "VmA01923456789.%hc ".ToCharArray());
